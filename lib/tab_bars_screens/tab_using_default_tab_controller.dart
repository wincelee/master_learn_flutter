...
class TabUsingDefaultTabController extends StatefulWidget {
  ...
  const TabUsingDefaultTabController({Key? key, required this.appBarTitle}) : super(key: key);

  @override
  State<TabUsingDefaultTabController> createState() => _TabUsingDefaultTabControllerState();
}

class _TabUsingDefaultTabControllerState extends State<TabUsingDefaultTabController> {
  @override
